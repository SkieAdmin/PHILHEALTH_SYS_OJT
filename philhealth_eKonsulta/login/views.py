...
def doctor_registration(request):
    ...
    return render(request, "login/doctor_registration.html")
...
def secretary_registration(request):
    ...
    return render(request, "login/secretary_registration.html")
...
def finance_registration(request):
    ...
    return render(request, "login/finance_registration.html")
